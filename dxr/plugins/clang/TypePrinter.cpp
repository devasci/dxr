...
//===----------------------------------------------------------------------===//
//
// This is a modified version of the Clang type printer for documentation.
//
//===----------------------------------------------------------------------===//
...
void printQualType(QualType type, StringRef name, std::string &answer,
  ...
  llvm::raw_string_ostream strout(answer);
  TypePrinter printer(pp);
  printer.print(type, strout, name);
}
